...
class CustomPasswordTextFieldWidget extends StatefulWidget {
  ...
  const CustomPasswordTextFieldWidget({Key? key, this.controller, this.hintTxt, this.focusNode, this.nextNode, this.textInputAction, this.border = false, this.prefixIconImage}) : super(key: key);
...
class CustomPasswordTextFieldWidgetState extends State<CustomPasswordTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(height: 42, width: double.infinity,
