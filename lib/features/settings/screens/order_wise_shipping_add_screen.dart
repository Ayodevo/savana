                ...
                Consumer<ShippingController>(builder: (context, shipProvider, child) {
                  return !shipProvider.isLoading ? CustomButtonWidget(
                    ...
                    onTap: ()  {
                      ...
                      if(title.isEmpty){
                        showCustomSnackBarWidget(getTranslated('enter_title', context),context);
                      }else if(cost.isEmpty){
                        showCustomSnackBarWidget(getTranslated('enter_cost', context),context);
                      }else if(duration.isEmpty){
                        showCustomSnackBarWidget(getTranslated('enter_duration', context),context);
                      } else{
