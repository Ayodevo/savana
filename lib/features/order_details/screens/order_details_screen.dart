  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                          ...
                                          child: SizedBox(width: 200,
                                            child: ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                              child: Container(decoration: BoxDecoration(
                                                  ...
                                                  child: CustomImageWidget(image: '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/${orderDetailsController.orderDetails![0].verificationImages?[index].image}')),
                                            ),
                                          ),
                                        ),
                                      );
      ...
      bottomNavigationBar: Consumer<OrderDetailsController>(
        builder: (context, orderDetailsController, _) {
          return (orderDetailsController.orderDetails != null && orderDetailsController.orderDetails![0].order!.orderType =='POS')? const SizedBox.shrink(): Container(
