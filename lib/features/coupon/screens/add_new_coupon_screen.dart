                  ...
                  return Padding(
                    ...
                    onTap: (){
                      ...
                      if(couponTitle.isEmpty){
                        showCustomSnackBarWidget(getTranslated('coupon_title_is_required', context), context);
                      }else if(couponCode.isEmpty){
                        showCustomSnackBarWidget(getTranslated('coupon_code_is_required', context), context);
                      }else if(limit.isEmpty){
                        showCustomSnackBarWidget(getTranslated('limit_is_required', context), context);
                      }else if(discountAmount.isEmpty && coupon.selectedCouponType == 'discount_on_purchase'){
                        showCustomSnackBarWidget(getTranslated('amount_is_required', context), context);
                      }else if(minimumPurchase.isEmpty){
                        showCustomSnackBarWidget(getTranslated('minimum_purchase_is_required', context), context);
                      }else if(maxDiscount.isEmpty && coupon.discountTypeName == 'percentage'){
                        showCustomSnackBarWidget(getTranslated('max_discount_is_required', context), context);
                      }else if(coupon.startDate == null && !update){
                        showCustomSnackBarWidget(getTranslated('start_date_is_required', context), context);
                      }else if(coupon.endDate == null && !update){
                        showCustomSnackBarWidget(getTranslated('end_date_is_required', context), context);
                      }else{
