...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  void initState() {
    ...
    if(_update) {
      ...
      Provider.of<AddProductController>(context,listen: false).productReturnImage = _product!.images;
    }else {
      _product = Product();
                                  ...
                                  child: Row(children: tags.map((String? tag) {
                                    return Container(decoration: BoxDecoration(
                                      ...
                                      child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                        ...
                                        InkWell(child: const Icon(Icons.cancel, size: 14.0,
                  ...
                  Align(alignment: Alignment.center, child: Stack(children: [
                    ClipRRect(
                      ...
                      child: resProvider.pickedMeta != null? Image.file(
                        ...
                        image: '${Provider.of<SplashController>(context).configModel!.
                          ...
                          child: Stack(children: [
                            DottedBorder(
                                ...
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                    child: (_update)?
                                    CustomImageWidget(image: "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.withColor[index].imageString}",
                                ...
                                return Stack(children: [
                                  DottedBorder(
                                      ...
                                      child: Container(decoration: const BoxDecoration(color: Colors.white,
                                        borderRadius: BorderRadius.all(Radius.circular(20)),),
                                          child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeSmall)),
                                              child: CustomImageWidget(image: "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.imagesWithoutColor[index]}",
                                                  width: MediaQuery.of(context).size.width/2.3,
                                                  height: MediaQuery.of(context).size.width/2.3,
                                                  fit: BoxFit.cover)))),
                                  ...
                                  Positioned(top: 5, right : 5,
                                    child: InkWell(onTap : () {
                                      resProvider.deleteProductImage(_product!.id.toString(), resProvider.imagesWithoutColor[index].toString(), null);
                                    },
