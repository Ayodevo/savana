...
class MenuBottomSheetWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<CustomBottomSheetWidget> activateMenu = [
      CustomBottomSheetWidget(image: '${Provider.of<SplashController>(context, listen: false).baseUrls!.sellerImageUrl}/'
          '${Provider.of<ProfileController>(context, listen: false).userInfoModel?.image}',isProfile: true, title: getTranslated('profile', context),
