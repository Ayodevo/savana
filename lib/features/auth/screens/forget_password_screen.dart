                    ...
                    onTap: () {
                      if(Provider.of<SplashController>(context,listen: false).configModel!.forgotPasswordVerification == "phone"){
                        if(_numberController.text.isEmpty) {
                          showCustomSnackBarWidget(getTranslated('PHONE_MUST_BE_REQUIRED', context), context);
                        }else{
                          ...
                          authProvider.forgotPassword(_numberController.text.trim()).then((value) {
                            if(value.isSuccess) {
                              ...
                              showCustomSnackBarWidget(getTranslated('input_valid_phone_number', context), context);
                            }
                          });
                        }
                      }else{
                        if(_controller.text.isEmpty) {
                          showCustomSnackBarWidget(getTranslated('EMAIL_MUST_BE_REQUIRED', context), context);
                        }
                        else {
