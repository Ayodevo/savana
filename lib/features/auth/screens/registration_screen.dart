                ...
                Container(height: 70,
                  ...
                  CustomButtonWidget(btnTxt: getTranslated('next', context), onTap: (){
                    if(authController.firstNameController.text.trim().isEmpty){
                      ...
                      showCustomSnackBarWidget(getTranslated('password_minimum_length_is_6', context), context);
                    }
                    else if(authController.confirmPasswordController.text.trim().isEmpty){
                      showCustomSnackBarWidget(getTranslated('confirm_password_is_required', context), context);
                    }else if(authController.passwordController.text.trim() != authController.confirmPasswordController.text.trim()){
                      showCustomSnackBarWidget(getTranslated('password_is_mismatch', context), context);
                    }
                  ...
                  Row( children: [
                      ...
                      Expanded(
                        child: CustomButtonWidget(
                          ...
                          showCustomSnackBarWidget(getTranslated('shop_name_is_required', context), context);
                          }else if(authController.shopAddressController.text.trim().isEmpty){
                          showCustomSnackBarWidget(getTranslated('shop_address_is_required', context), context);
                          }else if(authController.shopLogo == null){
                          showCustomSnackBarWidget(getTranslated('shop_logo_is_required', context), context);
                          }else if(authController.shopBanner == null){
                          showCustomSnackBarWidget(getTranslated('shop_banner_is_required', context), context);
                            ...
                            showCustomSnackBarWidget(getTranslated('secondary_banner_is_required', context), context);
                          }else{
