    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Sorry, we couldn\'t find any products matching your search.'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
              ...
              children: [
                ...
                Consumer<SearchProductController>(
                  builder: (context, searchProvider, child) {
                    return (searchProvider.searchedProduct != null && searchProvider.isClear) ?
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      for (int index =0; index < searchProvider.historyList.length; index++)
                                        Padding(
                                              ...
                                              child: ConstrainedBox(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      onTap: () => searchProvider.historyList.removeAt(index),
                                                      child: SizedBox(
                                                        width: 20,
                                                        child: Image.asset(
                                                          Images.cancel,
                          ...
                          child: Consumer<SplashController>(
                            builder: (context, popularTagProvider,_) {
                              return Wrap(
                                ...
                                alignment: WrapAlignment.start,
                                children: [
                                  for (int index = 0; index < popularTagProvider.configModel!.popularTags!.length; index++)
                                    Padding(
                                      padding:  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                                      child: Container(
                                        decoration: BoxDecoration(
