              ...
              Padding(
                ...
                CustomButtonWidget(btnTxt: getTranslated('add', context),
                  ...
                  if(firstName.isEmpty){
                    ...
                    showCustomSnackBarWidget(getTranslated('email_name_is_required', context), context);
                    ...
                    showCustomSnackBarWidget(getTranslated('country_is_required', context), context);
                  }else if(city.isEmpty){
                    showCustomSnackBarWidget(getTranslated('city_is_required', context), context);
                  }else if(zip.isEmpty){
                    showCustomSnackBarWidget(getTranslated('zip_is_required', context), context);
                  }else if(address.isEmpty){
                    showCustomSnackBarWidget(getTranslated('address_is_required', context), context);
                  }else{
