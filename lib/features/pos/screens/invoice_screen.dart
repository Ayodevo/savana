              ...
              builder: (context, cartController, _) {
                if(cartController.invoice != null &&  cartController.invoice!.orderAmount != null){
                  totalPayableAmount = cartController.invoice!.orderAmount! +
                      cartController.totalTaxAmount - cartController.discountOnProduct - cartController.invoice!.extraDiscount! - cartController.invoice!.discountAmount!;
                }
                        ...
                        child: Column(children: [
                          ...
                          Column(children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              ...
                              Text(' - ${PriceConverter.convertPrice(context, cartController.invoice!.extraDiscount)}'),
                            ],),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
