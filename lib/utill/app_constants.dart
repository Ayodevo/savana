...
class AppConstants {
  ...
  static const String companyName = 'savana';
  static const String baseUrl = 'https://savanatn.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.unitedKingdom, languageName: 'Frensh', countryCode: 'US', languageCode: 'en'),
  ];
}
